...
import { ADD_UPDATE_ACCOUNT, SET_ROLE_ACCOUNT } from './config/pathes.mjs';
...
app.use(auth(JSON.stringify({path:ADD_UPDATE_ACCOUNT, method:"POST"}),JSON.stringify({path:SET_ROLE_ACCOUNT, method:"PUT"}) ))
